(() => {
  ...
  style.textContent = `
    ...
    .tk-message{white-space:pre-line}.tk-dialogue{max-height:300px}
  ...
  const processCommand = async raw => {
    ...
    if (q.includes('che domande') || q.includes('cosa posso chiederti') || q.includes('cosa ti posso chiedere') || /\b(aiuto|cosa puoi fare|comandi)\b/.test(q)) {
      const reply='Ecco cosa puoi chiedermi in questa versione:\n\n• Apri o mostrami la Gestione mezzi\n• Ci sono mezzi in scadenza?\n• Quali revisioni scadono a breve?\n• Controlla assicurazioni, bolli o tagliandi\n• Aggiungi un nuovo mezzo\n• Apri il magazzino o mostrami gli attrezzi\n• Apri Personale e squadre\n• Apri il programma giornaliero\n• Apri la Gestione commesse\n• Apri il Centro costi\n• Apri la Gestione social\n• Apri i rifornimenti\n• Stampa il report in bianco dei rifornimenti\n• Stampa il report per tutti i mezzi o per un mezzo specifico\n• Torna alla Home\n\nPuoi formulare le richieste anche con parole diverse: cercherò di capirle.';
      addMessage(reply);speak('Ecco l’elenco dei comandi disponibili. Puoi leggerli nella chat.');return;
    }
